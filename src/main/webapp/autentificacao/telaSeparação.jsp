...
<head>
    ...
    <!-- CORRIGIDO: caminho do ícone para usar request.getContextPath() -->
...
<body>
<header>
    <!-- CORRIGIDO: src da imagem para "Nova logo.png" -->
...
<main>
    <!-- CORRIGIDO: link aponta para cadastroIndustria.jsp -->
    <a href="<%= request.getContextPath() %>/autentificacao/cadastro.jsp">
        <div class="industria">
            <h2>Indústria</h2>
    ...
    <!-- LINK CORRETO: já estava apontando para cadastroUsuario.jsp -->
    <a href="<%= request.getContextPath() %>/autentificacao/cadastroUsuario.jsp">
        <div class="usuario">
            <h2>Usuário</h2>
